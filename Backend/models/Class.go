...
type Class struct {
	...
	StartDate     time.Time    `gorm:"datetime;not null;uniqueIndex:unique_class" json:"start_date,string"`
	EndDate       time.Time    `gorm:"datetime;not null;uniqueIndex:unique_class" json:"end_date,string"`
