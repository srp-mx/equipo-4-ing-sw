...
const selectedfetch = async (option : string , selection : Array<Assigment>, dispatch : any) => {
        ...
        <div className="flex space-x-2">
                <div className={selection.length > 0 ? "flex space-x-2 text-white" : "hidden"}>
                    <button 
                        ...
                        onClick={() => selectedfetch("complete", selection, dispatch)}
                        >
                    ...
                    <button 
                        ...
                        onClick={() => selectedfetch("incomplete", selection, dispatch)}>
                    ...
                    <button 
                        ...
                        onClick={() => selectedfetch("delete", selection, dispatch)}>
