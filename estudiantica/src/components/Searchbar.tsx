...
export default function Searchbar(){
    const options = ['Completado','No completado','En progreso']
        ...
        <form className="mx-auto w-full">
            <div className="flex relative">
                ...
                <div className="relative w-full">
                    <input type="search" id="search-dropdown" className="block p-2.5 w-full z-20 text-sm rounded-e-lg  border bg-gray-700 border-s-gray-700  border-gray-600 placeholder-gray-400 text-white" placeholder="Buscar Tareas..." required />
                    <button type="submit" className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-[#cbda3d] rounded-e-lg hover:bg-white">
