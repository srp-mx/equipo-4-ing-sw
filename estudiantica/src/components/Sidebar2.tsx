...
export const Sidebar2 = ({ incomplete }: { incomplete?: boolean }) => {
    return (
        !incomplete ? (
            <div
            ...
            <div
                className="row-span-4 ml-4 text-white text-3xl items-start flex mt-6 flex-col mb-6 py-1 space-x-1 space-y-4"
            >
                <Link to="/work"
