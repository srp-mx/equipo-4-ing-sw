    ...
    return (
        <div className="bg-[#0B090F] h-screen w-screen bg-cover bg-center overflow-hidden">
            ...
            <div className="flex flex-col-reverse md:grid md:grid-cols-10 md:grid-rows-4 h-[calc(100vh-90px)] w-full">
                ...
                <div 
                className="md:col-span-6 md:row-span-4 md:col-start-3 md:mr-6 h-full p-1 mx-4 mr-3 rounded-2xl flex flex-col overflow-y-auto"
                style ={{ backgroundImage: `url(${bgImage}) `, backgroundSize: 'cover' }}>
                    <Character />
                </div>
                <div className="hidden md:block md:col-span-2 md:row-span-4 md:col-start-9 md:mr-6 md:mb-2">
                    <Stats />
                </div>
            </div>
        </div>
